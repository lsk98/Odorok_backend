...
public class DiaryServiceGptChatTest {
    ...
    @BeforeEach
    void setUp() {
        VisitedAttraction mockAttraction1 = new VisitedAttraction("해운대", "부산 해운대구 우동", "해운대해수욕장, 광안리해수욕장, 벡스코(BEXCO), 누리마루 등이 있다.");
        VisitedAttraction mockAttraction2 = new VisitedAttraction("해운대블루라인파크", "부산광역시 해운대구 달맞이길62번길 13","수려한 해안 절경을 따라 해운대 해변열차와 해운대 스카이캡슐을 운행");
